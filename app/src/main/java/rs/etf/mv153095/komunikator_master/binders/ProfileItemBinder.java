 ...
 */
public class ProfileItemBinder implements SimpleCursorAdapter.ViewBinder {
    @Override
    public boolean setViewValue(View view, Cursor cursor, int columnIndex) {

        if (view.getId() == R.id.ImageView_profileImage) {
            // fetch path from DB
            String path = "";
            ...
            return true;
        } else if (view.getId() == R.id.TextView_profileName) {
            ...
            return true;
        } else if (view.getId() == R.id.TextView_profileLastName) {
            // fetch profile last name from DB
